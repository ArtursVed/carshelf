...
insert into cars (id, type, number, fuel, year , cost , image) values (-1, 'AUDI','LV1234','Petrol', 2016, 16000 , 'audi1.jpg')
insert into cars (id, type, number, fuel, year , cost , image) values (-2, 'VOLVO','LV5555','Petrol', 2017, 20000 'volvo.jpg')
