...
insert into cars (id, type, number, fuel, year , cost) values (1, 'AUDI','LV1234','Petrol', 2016, 16000)
insert into cars (id, type, number, fuel, year , cost) values (2, 'VOLVO','LV5555','Petrol', 2017, 20000)
insert into cars (id, type, number, fuel, year , cost) values (3, 'VW','LV6666','diesel', 2018, 25000)
insert into cars (id, type, number, fuel, year , cost) values (4, 'MAZDA3','GR5382','Petrol', 2007, 6000)
insert into cars (id, type, number, fuel, year , cost) values (5, 'MITSUBISHI OUTLANDER','HS1900','Petrol', 2011, 11000)
insert into cars (id, type, number, fuel, year , cost) values (6, 'VOLVO XS','OM5261','diesel', 2015, 15000)